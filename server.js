...
const CHECKLISTS = {
  "Cleaning|Between tenant cleaning": [
    ...
    "Dish soap","dish sponge","Duster","Dustpan","Floor cleaner","garbage bags",
    "goo gone","goof off","green score pad","magic erasers","metal razor",
    "metal sponges","mop","Oven cleaner","plastic razor","rags","roll of paper towel",
  ...
  "Cleaning|General cleaning": [
    ...
    "Dustpan","Floor cleaner","garbage bags","Mop","mop bucket","Rags",
  ...
  "Cleaning|Post construction cleanup": [
    "Construction broom","Contractor bags","Dust broom (big blue)","garbage bags","Shovel"
  ],
